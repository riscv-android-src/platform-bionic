...
#define fourcc_mod_vs_code(type,val) fourcc_mod_code(VS, ((((__u64) type) << 54) | (val)))
...
#define fourcc_mod_vs_dec_code(tile,align) fourcc_mod_vs_code(DRM_FORMAT_MOD_VS_TYPE_COMPRESSED, ((tile) | (align)))
...
#define fourcc_mod_vs_custom_code(tile) fourcc_mod_vs_code(DRM_FORMAT_MOD_VS_TYPE_CUSTOM_10BIT, (tile))
#ifdef __cplusplus
}
#endif
#endif
